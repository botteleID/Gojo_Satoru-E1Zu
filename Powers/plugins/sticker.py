...
@Gojo.on_message(filters.command("stickerid"))
...
@Gojo.on_message(filters.command("getsticker"))
...
@Gojo.on_message(filters.command("kang"))
...
async def kang(client, message: Message):
    ...
    try:
        ...
        return print(e)
    packnum = 0
    packname = "f" + str(message.from_user.id) + "_by_" + {Config.BOT_USERNAME}
    limit = 0
    try:
        while True:
            if limit >= 50:
        ...
        await msg.edit("You Need To Start A Private Chat With Me.")
...
__alt_name__ = ["stickerid", "kang", "getsticker", "webss"]
