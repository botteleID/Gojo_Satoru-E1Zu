...
PAGI = ( 
"Buka matamu agar matahari bisa terbit, bunga bisa mekar, karena semua menunggu untuk melihat senyum indahmuSelamat pagi.",
"Selamat pagi sayangBukalah jendela kamarmu kemudian hiruplah udara sejuk pagi iniKarena bersama aromanya terdapat cintaku yang menyatu dengan udara pagi.",
"Cukup melihat senyummu sekali bisa bertahan sepanjang hariSelamat pagi pacar tercinta.",
"Dirimu adalah alasan kebahagiaan yang aku butuhkanSelamat pagi.",
"Entah mirip apa cuaca alam pagi iniAku pun sangat susah mengungkapkannyaYang terpenting adalah aku ingin mendoakanmu pagi iniSelamat pagi sayang, semoga hari mu selalu penuh kebahagiaan.",
"Hanya sedetik untuk berpikir tentangmu saat pagi tibaNamun, senyuman di wajahku berlangsung hingga sepanjang hariSelamat pagi!",
"Selamat pagi sayangJatuh cintalah dengan hidupmuSetiap menitnyaSeperti aku jatuh cinta kepadamuSetiap waktu.",
"Langit mendung tetap terlihat cerah, udara dingin tetap terasa hangatItu semua karena ada senyummu yang selalu menemani hari-harikuSelamat pagi sayang.",
"Lihatlah mentari pagi ini tersenyum sangat indahKau tau kenapa? Karena mentari pagi dan saya sama-sama ingin mengucapkan selamat pagi untukmuSelamat pagi.",
"Matahari seperti kamu , walau jauh tapi bisa menghangatkan akuSelamat pagi sayang.",
"Selamat pagi untuk matahari kecilkuSemoga hari ini kamu diberkahi oleh Tuhan.",
"Senyummu adalah salah satu alasan dan motivasi aku untuk hidupSelamat pagi sayang.",
"Setiap bangun pagi selalu memikirkan kamu yang sabar menanti menunggu kedatangankuSelamat pagi sayang.",
"Setiap pagi senyumlah di depan cermin, lakukanlah perubahan yang lebih baik untuk hubungan kita, yaSelamat pagi.",
"Sinar matahari pagi memang begitu cantik, tetapi sinar matahari akan kalah cantik bila dibandingkan dengan senyum indahmuSelamat pagi untuk kamu.",
"Tidak perlu susah-susah membuatku bahagia, karena hanya dengan memikirkanmu saja sudah membuat pagiku menjadi terasa lebih indahSelamat pagi",
"Cukup dengan bersamamu setiap hari saja aku sudah sangat bersyukurSelamat pagi sayang.",
"Cahaya mentari akan selalu hadir menjemput pagiTiada pernah lelah untuk memberi kehangatan dan semangatSelamat pagi belahan jiwa.",
"Cahaya pagi memberikan rona baru pada wajahmu yang begitu indahEngkau mentariku menghangatkan kalbu, pembangkit semangatkuEngkau jiwa ragakuSelamat pagi, cintaku.",
"Jika ada mentari yang menyinari bumiMaka ada aku yang siap menjemputmu pagi iniSelamat Pagi.",
"Kamu dan kopi seperti bilangan ganjil yang menggenapkan akuSelamat pagi pujaan hatiku!",
"Matahari yang hangat, selalu mengingatkanku padamuSelamat pagi kamu yang terkasih.",
"Pagi hari yang indah datang menghampiriku, untuk memberikan warna keindahanKarena hanya engkaulah penyemangatku, kekasih hati.",
"Sebuah pagi sempurna, hanya jika aku bersama kamuSebuah pagi tidak lengkap jika tanpa senyuman kamuSelamat pagi, kamu terkasih.",
"Selamat pagi untuk kamu yang selalu ada di dalam pikiran dan doakuSemoga kita segera dipersatukan oleh waktu.",
"Semangat pagi kamu yang terbit dan merekah di sudut hati, kamu yang tersenyum serta menari di sela-sela imajikuSelamat memulai hari ini.",
"Terbitnya matahari beri senyuman untuk jiwa-jiwa yang bangun di pagi hariSelamat pagi kamu yang terkasih, semoga hal baik selalu mendampingimu.",
"Aku akan rela melihatmu jauh di sana jika itu semua demi cita-cita dan tujuan hidupmuSelamat pagi sayang, jangan lupa sarapan sebelum kerja.",
"Selamat pagi sayangku yang jauh disanaWalaupun jauh, kamu tetap di hatikuJauh di mata dekat di hati.",
"Selamat pagi untuk kamu yang selalu ada untukku, kamu yang paling bisa membuatku rindu dan untuk semua semangat yang selalu terinspirasi.",
"Selamat pagi untuk seseorang yang selalu ada di dalam doa namun tidak terlihat oleh mataSelamat pagi untukmu yang jauh di sana.",
"Selamat pagi, selamat berjuang sayangNiatkan usahamu saat ini untuk segera menghalalkan akuInsyaallah akan dimudahkan segalanyaSemangat terus ya!",
"Jarak bukanlah penentu kita akan tetap mesra dan tetap bersamaJika kita saling mendukung dalam setiap pekerjaan dan saling meyakini setiap apa yang kita lakukan, percayalah semua akan indahSelamat pagi.",
"Selamat pagi sayang, aku tidak sabar berjumpa denganmu dan melepas rindu.",
"Selamat pagi sayang, tidak ada yang bisa menghitung berapa banyak tetesan embun yang membasahi bumi pagi iniBegitu juga rinduku padamu, tak ada yang mampu menghitung seberapa besar rinduku padamu pagi ini.",
"Selamat pagi, Akan ku obati lelahmu dengan senyum manis dan pelukan hangat, walaupun hanya lewat ponsel",
"Selamat pagi, Sekalipun kemarin malam badai menghadang, ada kamu yang menjadi semangat pagiku.",
"Udara pagi memang menyejukkan, tetapi lebih menyejukkan lagi ketika melihat wajahmuSelamat pagi sayang, aku merindukanmu.",
"Aku mencintaimu dengan penuh kesabaran dan ketulusan hatiku, meski kita terhalang oleh jarak, namun rasa ini tak akan pernah pudar untukmu sayangSelamat pagi.",
"Selamat pagi untuk kamu yang selalu ada untukku, kamu yang paling bisa membuatku rindu, dan menjadi semangat hidupku.",
"Cukup dengan bersamamu setiap hari saja aku sudah sangat bersyukurSelamat pagi sayang.",
"Tidak ada yang bisa menghitung berapa banyak tetesan embun yang membasahi bumi pagi iniBegitu juga rinduku padamu, tak ada yang mampu menghitung seberapa besar rinduku padamu pagi ini.",
"Cahaya pagi memberikan rona baru pada wajahmu yang begitu indah, selamat pagi.",
"Selamat pagi, semoga hari ini dan hari berikutnya menjadi hari yang istimewa buat kita.",
"Semangat pagi kamu yang terbit dan merekah di sudut hati, kamu yang tersenyum serta menari di sela-sela imajikuSelamat memulai hari ini.",
"Cahaya mentari akan selalu hadir menjemput pagiTiada pernah lelah untuk memberi kehangatan dan semangatSelamat pagi belahan jiwa.",
"Jika ada mentari yang menyinari bumiMaka ada aku yang siap menjemputmu pagi iniSelamat Pagi.",
"Sebuah pagi sempurna, hanya jika aku bersama kamuSebuah pagi tidak lengkap jika tanpa senyuman kamuSelamat pagi, kamu terkasih.",
