...
`OWNER_ID`: Your user ID as an integer. You can get it from [@SessionBot](https://telegram.dog/SessionBot)

`SUPPORT_GROUP`: Your Telegram support group chat username where user's can contact in case of a problem.

`MESSAGE_DUMP`: Event logs channel where bot will send updates. Note that id should starts with `-100`. You can get it from [@SessionBot](https://telegram.dog/SessionBot)
...
`DEV_USERS`: ID of users who are Devs of your bot. Use space to seprate values. You can get there id's from [@SessionBot](https://telegram.dog/SessionBot)

`SUDO_USERS`: A space separated list of user IDs who you want to assign as sudo users. You can get there id's from [@SessionBot](https://telegram.dog/SessionBot)

`WHITELIST_USERS`: A space separated list of user IDs whitelisted, cannot be restricted. You can get there id's from [@SessionBot](https://telegram.dog/SessionBot)
